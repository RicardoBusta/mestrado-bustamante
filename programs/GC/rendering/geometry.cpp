...
QhFace::QhFace(const QVector<QVector3D> &v)
  : valid_(true)
{
  if(v.size()<3){
    valid_ = false;
...
QhFace::QhFace(const QVector<QVector3D> &v, const QColor &color)
  : valid_(true)
{
  if(v.size()<3){
    valid_ = false;
...
QhFace::QhFace(const QVector3D &v0, const QVector3D &v1, const QVector3D &v2, const QColor &color)
  : valid_(true)
{
  v_.resize(3);
  v_[0] = v0;
...
void QhFace::Draw(const float &spread, const float &shrink, const bool user_color) const
{
  glPushMatrix();
...
void QhFace::DrawTetraFace(const bool user_color) const
{
...
void QhFace::SetColor(const QColor &color)
{
  color_ = color;
}
...
{
  f[0] = new QhFace(v0,v1,v2);
  f[1] = new QhFace(v0,v2,v1);
...
{
  f[0] = new QhFace(v0,v1,v2);
  f[1] = new QhFace(v1,v3,v2);
  f[2] = new QhFace(v3,v1,v0);
  f[3] = new QhFace(v2,v3,v0);
