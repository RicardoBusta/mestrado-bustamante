...
namespace Busta{
  ...
  {
    if( data_[ 0]==1.0f && data_[ 1]==0.0f && data_[ 2]==0.0f && data_[ 3]==0.0f &&
        data_[ 4]==0.0f && data_[ 5]==1.0f && data_[ 6]==0.0f && data_[ 7]==0.0f &&
        data_[ 8]==0.0f && data_[ 9]==0.0f && data_[10]==1.0f && data_[11]==0.0f &&
        data_[12]==0.0f && data_[13]==0.0f && data_[14]==0.0f && data_[15]==1.0f ) return true;
    return false;
  }
